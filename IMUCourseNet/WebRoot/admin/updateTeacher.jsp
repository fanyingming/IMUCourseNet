  ...
  <body>
   ...
   <div class="zhu">
	    ...
	    <div id="add">
	    	...
	    	<a>&nbsp;</a>
				<form name="form1" method="post" action="updateTeacher">
				<input type="hidden" name="userId" value="<s:property value="teacher.userId" />">
	    		<table class="add_content_tab">
	    			<tr>
	    				<td class="addtd1"><a>账号：</a></td><td class="addtd2">
	    				<input type="text" name="userAccount" value="<s:property value="teacher.userAccount" />">
	    				</td>
	    			</tr>
	    			<tr>
	    				<td class="addtd1"><a>密码：</a></td><td class="addtd2">
	    				 <input type="password" name="userPass" value="<s:property value="teacher.userPass" />" >
	    				</td>
	    			</tr>
					<tr>
	    				<td class="addtd1"><a>姓名：</a></td><td class="addtd2">
	    				<input type="text" name="userName" value="<s:property value="teacher.userName" />">
	    				</td>
	    			</tr>
	    			<tr>
	    				<td class="addtd1"><a>邮箱地址：</a></td><td class="addtd2">
	    				<input type="text" name="userMail" value="<s:property value="teacher.userMail" />">
	    				</td>
	    			</tr>
	    			<tr>
