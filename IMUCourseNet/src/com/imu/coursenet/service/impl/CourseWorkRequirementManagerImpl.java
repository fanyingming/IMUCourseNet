...
public class CourseWorkRequirementManagerImpl implements
		CourseWorkRequirementManager {
	...
	public int addCourseWorkRequirement(int courseDetailId, String title,
		...
		CourseWorkRequirement courseWorkRequirement = new CourseWorkRequirement(
				title, requirementContent, new Date(), deadLine, courseDetail);
