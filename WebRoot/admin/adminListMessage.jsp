	    ...
	    <div id="medium">
		    ...
		    <div id="messages">
		   	...
		   	共&nbsp;<span>
			    ...
			    [&nbsp;<a href="adminListMessage?currentPage=1">首页</a><span>|</span>
			    <a href="adminListMessage?currentPage=<s:property value="currentPage-1"/>">上一页</a><span>|</span>
			    <a href="adminListMessage?currentPage=<s:property value="currentPage+1"/>">下一页</a><span>|</span>
			    <a href="adminListMessage?currentPage=<s:property value="totalPageCounts"/>">末页</a>
