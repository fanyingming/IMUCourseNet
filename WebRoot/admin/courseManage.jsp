...
<link rel="stylesheet" type="text/css" href="css/detail.css">
  ...
  <body>
		    ...
		    <table class="medium_content_tabal1">
			    <tr>
			    	<td style="text-align: left;">
			    		...
			    		<input type="button" value=" 添 加 " onclick= "fom.action='admin/addCourse.action';fom.submit(); ">
			    	</td>
			    </tr>
			    <tr>
				    <td width="100%">
					    <table border="0" cellpadding="3" cellspacing="1" width="100%" align="center" style="background-color: #464646;text-align: center;">
					    	<tr>
		                   	 	<td height="25" colspan="13" align="left" bgcolor="#aaaaaa"><p>课程列表</p></td>
		                    </tr>
    ...
    <tr style="background:#ffffff;">
      ...
      <td><s:property value="#course.department.departmentName"/></td>
      <td><s:property value="#course.courseType.courseTypeName"/></td>
             <td> 	
		...
		<a href="beforeUpdateCourse.action?courseId=<s:property value="#course.courseId"/>">修改</a></td>
			    ...
			    <tr id="bottom">
			    	<td class="bottom_left">
			    		...
			    		[&nbsp;<a href="listCourse?currentPage=1">首页</a><span>|</span>
			    		<a href="listCourse?currentPage=<s:property value="currentPage-1"/>">上一页</a><span>|</span>
			    		<a href="listCourse?currentPage=<s:property value="currentPage+1"/>">下一页</a><span>|</span>
			    		<a href="listCourse?currentPage=<s:property value="totalPageCounts"/>">末页</a>
