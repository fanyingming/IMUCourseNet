	    ...
	    <div id="add">
	    	...
	    	<a>&nbsp;</a>
	    		...
	    		<table class="add_content_tab">
	    			<tr>
	    				<td class="addtd1"><a>课程类型名称：</a></td><td class="addtd2">
	    			...
	    			<tr>
	    				...
	    				<textarea name="courseTypeDescription" cols="105" rows="10" ><s:property value="courseType.courseTypeDescription" /></textarea>
