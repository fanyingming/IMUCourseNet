				    ...
				    <td width="100%">
					    <table border="0" cellpadding="3" cellspacing="1" width="100%" align="center" style="background-color: #464646;text-align: center;">
							...
							<tr bgcolor='#ffffff'>
								...
								<td><s:property value="#courseTaking.courseDetail.course.courseName"/></td>
								<td><s:property value="#courseTaking.courseDetail.course.courseType.courseTypeName"/></td>
								<td><s:property value="#courseTaking.courseDetail.teacher.userName"/></td>
								<td><s:property value="#courseTaking.courseDetail.establishDate"/></td>
								<td>
									<s:if test="#courseTaking.courseDetail.state==1">
										开通
									</s:if>
									<s:else>
										结束
								...
								<td><s:property value="#courseTaking.student.userName"/></td>
							</tr>
							</s:iterator>
					    </table>
				    </td>
