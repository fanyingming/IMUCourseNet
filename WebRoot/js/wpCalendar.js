...
document.writeln('<iframe id=wpCalendarLayer name=wpCalendarLayer frameborder=0 onmouseout="wpCalendar.correctPosition()" style="position: absolute; width: 180; height: 228; z-index: 9998; display: none"></iframe>');
...
function wpCalendar(){
	...
	this.themename	= "Nostalgia";						//主题设置，决定日历的外观
	...
	this.redraw		= function (){				//定义redraw方法，用于重绘整个日历
		//==================================================== WEB 页面显示部分 =====================================================
		if(this.cellwidth<30)this.cellwidth=30;
		if(this.cellheight<20)this.cellheight=20;
		this.theme = typeof theme[this.themename] == "object"? theme[this.themename] : theme["Nostalgia"];
