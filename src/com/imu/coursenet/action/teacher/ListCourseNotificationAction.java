...
public class ListCourseNotificationAction extends ManagerBaseAction {
	...
	public void setCourseNotifications(List<CourseNotification> courseNotifications) {
	...
	public String execute() throws Exception {
		...
		courseNotifications = courseNotificationManager.listCourseNotificationByCourseDetailId(courseDetailId);
		return SUCCESS;
	}
